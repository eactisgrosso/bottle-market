...
For getting started you have to follow the below procedure. First navigate to the `bottle-market` directory. Then run below command for getting started with specific part.

```
// on bottle-market directory
yarn
```
